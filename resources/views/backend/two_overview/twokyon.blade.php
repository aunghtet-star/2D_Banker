...
@section('2D-over-kyon','mm-active')
@section('main')
<div class="app-main__inner">
    ...
    <div class="container p-0">
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="two-kyon-table" id="reload">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
                    ...
                    function twoKyonTable(){
                        var date = $('.date').val();
                        var time = $('.time').val();
                        
                        $.ajax({
                            url : `/admin/two-overview/two-kyon-table?date=${date}&time=${time}`,
                            type : 'GET',
                            success : function(res){
                                    $('.two-kyon-table').html(res);
                            }
                        })
